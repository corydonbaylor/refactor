...
CSV_FILES = {
    ...
    'New York City': 'app/viz/resources/maps/nyc.csv',
    'Philadelphia': 'app/viz/resources/maps/philly.csv',
    'San Francisco': 'app/viz/resources/maps/sanfran.csv',
    'Washington DC': 'app/viz/resources/maps/washington.csv',

}

@viz_bp.route('/subways', methods=['GET', 'POST'])
def map_view():
    # Default to NYC map if no file is selected
